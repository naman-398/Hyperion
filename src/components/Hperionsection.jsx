            ...
            <div className=' max-w-[1409px] mx-auto px-3'>
                ...
                <div className=' flex flex-wrap -mx-3 flex-row mt-[30px] sm:mt-[64px] items-center'>
                    <div className=' w-full xl:w-1/2 px-3 xl:h-[565px] relative'>
                        ...
                        <img src={BlackLayer} alt="blacklayer" className=' absolute bottom-[-1%]  w-full xl:min-w-[1087px] xl:right-[11%] right-0' />
                    </div>
                    <div className=' w-full xl:w-1/2 px-3 pt-3 sm:pt-6 xl:pt-0'>
                        <div className=' xl:max-w-[608px]  '>
                            ...
                            <p className=' font-poppins font-normal  text-base sm:text-lg !leading-[23.4px] text-snow_drift opacity-70 mb-6 sm:mb-12 text-center xl:text-start'>And the best part? Hyperion is decentralized and permissionless — giving you security and complete control over your funds and trades.</p>
