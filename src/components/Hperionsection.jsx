...
const Hperionsection = () => {
    return (
        <div className=' pt-[50px] sm:pt-[80px] lg:pt-[140px] relative'>
            <div className=' max-w-[1368px] ms-auto px-3'>
                <h2 className=' xl:max-w-[976px] text-center text-transparent bg-clip-text bg-text_gradient1 tracking-[-2%]  fw-medium text-[38px] 576:text-[45px] sm:text-[50px]  md:text-[56px] leading-[38px] 576:leading-[45px] sm:leading-[50px] md:leading-[56px]'>   Hyperion isn't just
                ...
                <div className=' flex flex-wrap -mx-3 flex-row mt-[30px] sm:mt-[64px] items-center'>
                    ...
                    <div className=' w-full xl:w-1/2 px-3 sm:pt-6 xl:pt-0'>
                        <div className=' xl:max-w-[608px]  xl:ms-auto '>
                            ...
                            <p className=' font-poppins fw-normal  text-base sm:text-lg leading-[23.4px] text-snow_drift opacity-70 mb-2 sm:mb-3 text-center xl:text-start'>We're focused on giving you the tools and data you need to succeed with ease.</p>
                            <p className=' font-poppins fw-normal  text-base sm:text-lg leading-[23.4px] text-snow_drift opacity-70 mb-6 sm:mb-12 text-center xl:text-start'>And the best part? Hyperion is decentralized and permissionless — giving you security and complete control over your funds and trades.</p>
