...
import hyperion from "../assets/images/webp/hyperion-section-img.webp";
import Commonbtn from './common/Commonbtn';
import HyperionSectionBg from "../assets/images/webp/hyperion-section-bg.webp";
import HyperionEllipse from "../assets/images/webp/hyperion-ellipse.webp";
    ...
    return (
        <div className=' pt-[35px] sm:pt-[50px] md:pt-[60px] lg:pt-[140px] relative z-0' >
            ...
            <div className=' max-w-[1409px] mx-auto px-3'>
                <h2 className=' xl:max-w-[995px] 1350:ms-5 text-center text-transparent pb-[4px] bg-clip-text bg-grey_gradient1 font-poppins tracking-[-2%]  font-medium text-[26px] 576:text-[30px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]'>   Hyperion isn't just
                ...
                <div className=' flex flex-wrap -mx-3 flex-row mt-[15px] sm:mt-7 lg:mt-[60px] items-center'>
                    ...
                    <div className=' w-full xl:w-1/2 px-3 pt-3 sm:pt-6 xl:pt-0'>
                        <div className=' xl:max-w-[608px]  '>
                            <p className=' text-transparent bg-clip-text bg-grey_gradient1 tracking-[-2%] text-[24px] md:text-[28px] lg:text-[30px] leading-[30px] font-poppins font-medium pb-3 sm:pb-6 text-center xl:text-start'>Decentralized Trade Insights</p>
