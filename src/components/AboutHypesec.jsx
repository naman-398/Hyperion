            ...
            <div className=' lg:mt-24 md:mt-[70px] mt-14 sm:mt-16 xl:mt-[140px]'>
                <div className=' max-w-[1368px] px-3 mx-auto'>
                    <div className='flex flex-col md:flex-row justify-between'>
                        <h2 className='mx-auto md:mx-0 text-center md:text-start  font-poppins grey_gradient_to_r text-transparent bg-clip-text font-medium text-2xl 576:text-3xl sm:text-4xl md:text-xxl lg:text-5xl xl:text-vxl md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px] max-w-[500px]'>About Hyperion</h2>
