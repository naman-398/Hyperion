...
const ExperienceSection = () => {
    return (
        <div className=' max-w-[1409px] mt-[38px] mx-auto px-3'>
            ...
            <div className=' mt-[64px] w-full p-[25px] sm:p-[64px] xl:p-[64px_84px] rounded-[24px] bg-img-experience1  bg-100% bg-center bg-no-repeat flex items-center flex-col lg:flex-row justify-between'>
