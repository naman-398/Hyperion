...
const ExperienceSection = () => {
    return (
        <div className=' max-w-[1409px] mt-[38px] mx-auto px-3 relative z-[2]'>
            ...
            <div className=' mt-[30px] sm:mt-16 w-full p-[25px] sm:p-16 xl:p-[64px_84px] rounded-[24px] bg-img-experience1 bg-[url(./assets/images/webp/power-experiencebg.webp)] bg_size_100 bg-center bg-no-repeat flex items-center flex-col lg:flex-row justify-between'>
