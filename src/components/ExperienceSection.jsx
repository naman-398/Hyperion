    ...
    return (
        <div className=' max-w-[1409px] mt-[38px] mx-auto px-3 relative z-[2]'>
            <div className=' flex flex-row  min-h-[325px] flex-wrap lg:flex-nowrap  justify-center'>
                <div className=' experience-card w-full md:w-1/2 lg:columns-auto pb-6 md:pb-0  max-w-[480px] md:max-w-[388px] px-3 sm:px-6 md:ps-0 md:pe-6 xl:pe-12 border-b-[1px] md:border-b-0 md:border-r-[1px] border-solid border-[#F9F9F70F] md:min-h-[325px]'>
                ...
                <div className=' experience-card w-full md:w-1/2 py-6 md:py-0 lg:columns-auto max-w-[480px] md:max-w-[436px] px-3 sm:px-6 xl:px-12 lg:border-r-[1px] border-b-[1px] border-solid md:border-b-0 border-[#F9F9F70F] md:min-h-[325px]'>
                    <div className=' w-[75px] experience-card-box duration-300 sm:w-[92px] p-[16px] sm:p-[26px] rounded-[24px] border-[1px] border-solid border-[#F9F9F714] bg-[#1F1F1F8A] mx-auto md:mx-0'>
                        <Chart />
                    </div>
                ...
                <div className=' experience-card2 w-full lg:columns-auto md:max-w-[544px] max-w-[480px] px-3 sm:px-6 md:pe-0 md:ps-6 xl:ps-12  md:min-h-[325px] mt-6 lg:mt-0'>
                    <div className=' w-[75px] experience-card-box duration-300 sm:w-[92px] p-[16px] sm:p-[26px] rounded-[24px] border-[1px] border-solid border-[#F9F9F714] bg-[#1F1F1F8A] mx-auto md:mx-0'>
                        <Recycle />
                    </div>
