...
import { Bitcoinicon, Cardanoicon, Ethereumicon, Litecoinicon, Solanaicon, Tethericon, Toncoinicon, Tronicon, Usdcicon, Xrpicon } from './common/Icon';
...
const EaseAndDiversity = () => {
  ...
  return (
    <div className='px-3 pt-12 lg:pt-0' id='trade'>
      <div className='rounded-[24px] sm:rounded-[48px] max-w-[1468px] bg-[url(./assets/images/webp/section2-bg.webp)] bg-center bg-cover relative z-[1] lg:bg-100% bg-no-repeat mx-auto p-[0_20px_20px_20px] sm:p-[0_30px_30px_30px] lg:p-[0_30px] xl:p-[0_64px_0_84px] overflow-hidden'>
          ...
          <div className='w-full lg:w-1/2 px-3 pt-6 lg:pt-0'>
            <div className='max-w-[576px] lg:me-0 mx-auto lg:ms-auto lg:h-[578px] flex flex-col justify-between'>
              <div className='font-poppins'>
                <h2 className='font-medium text-[26px] 576:text-[30px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px] text-transparent bg-clip-text bg-grey_gradient1 pb-3 sm:pb-6 tracking-[-2%] text-center lg:text-start'>Ease and diversity in trading</h2>
