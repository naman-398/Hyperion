                ...
                <div className=' flex flex-wrap -mx-3 flex-col-reverse xl:flex-row '>
                    <div className=' w-full xl:w-1/2 px-3 pt-3 sm:pt-6 xl:pt-[84px] relative z-[2]'>
                        <div className=' xl:max-w-[608px]  xl:me-auto '>
                            <p className=' text-transparent bg-clip-text bg-grey_gradient tracking-[-2%] text-2xl 576:text-xlg sm:text-4xl md:text-xxl lg:text-5xl xl:text-vxl md:leading-[56px] leading-9 576:leading-10 sm:leading-[46px] font-poppins font-medium pb-3 sm:pb-6 md:pb-12 text-center xl:text-start'>Mission Hyperion</p>
