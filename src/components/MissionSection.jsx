                ...
                <div className=' flex flex-wrap -mx-3 flex-col-reverse xl:flex-row '>
                    <div className=' w-full xl:w-1/2 px-3 pt-3 sm:pt-6 xl:pt-[84px]'>
                        <div className=' xl:max-w-[608px]  xl:me-auto '>
                            <p className=' text-transparent bg-clip-text bg-text_gradient1 tracking-[-2%] text-[38px] 576:text-[45px] sm:text-[50px]  md:text-[56px] leading-[38px] 576:leading-[45px] sm:leading-[50px] md:leading-[56px] font-poppins font-medium pb-3 sm:pb-6 md:pb-12 text-center xl:text-start'>Mission Hyperion</p>
