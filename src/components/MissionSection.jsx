                ...
                <div className=' flex flex-wrap -mx-3 flex-col-reverse xl:flex-row '>
                    <div className=' w-full xl:w-1/2 px-3 pt-3 sm:pt-6 xl:pt-[84px] relative z-[2]'>
                        <div className=' xl:max-w-[608px]  xl:me-auto '>
                            <p className=' text-transparent bg-clip-text bg-text_gradient1 tracking-[-2%] text-[30px] sm:text-[38px] md:text-[44px] lg:text-[56px] md:leading-[56px] leading-[40px] sm:leading-[46px] font-poppins font-medium pb-3 sm:pb-6 md:pb-12 text-center xl:text-start'>Mission Hyperion</p>
