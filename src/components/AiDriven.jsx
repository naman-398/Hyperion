...
const AiDriven = () => {
    return (
        <div className=' mt-12 sm:mt-20 xl:mt-[140px] bg-[url(./assets/images/webp/ai-drivenbg.webp)] bg-cover bg-center bg-no-repeat' >
            <div className=' max-w-[1409px] mx-auto px-3'>
                <div className=' flex min-[1200px]:items-end justify-between flex-col min-[1200px]:flex-row'>
                    <h2 className=' min-[1200px]:max-w-[864px] text-center font-poppins font-medium  text-transparent bg-clip-text bg-grey_gradient tracking-[-2%] text-2xl 576:text-3xl sm:text-4xl md:text-xxl lg:text-5xl xl:text-vxl md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]'> The hyperion
                ...
                <div className=' flex flex-wrap justify-center flex-row -mx-3 mt-[30px] sm:mt-16'>
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-snow_drift_light bg-dark_red rounded-3xl overflow-hidden aiDrivencard h-full'>
                            <div className=' max-w-[440px] max-h-[313px] rounded-tl-3xl rounded-tr-6 overflow-hidden '>
                                <img src={AIdriven1} alt="aidriven" className=' xl:w-[440px] xl:h-[313px] aidriven ai-drivenimg duration-300 ' />
                            </div>
                            <div className=' p-5 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-grey_gradient font-poppins font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>AI-Driven insights</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-5 sm:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-snow_drift_light bg-dark_red rounded-3xl overflow-hidden aiDrivencard h-full'>
                            <div className=' max-w-[440px] max-h-[313px] rounded-tl-3xl rounded-tr-[24px] overflow-hidden '>
                                <img src={AIdriven2} alt="aidriven" className=' xl:w-[440px] xl:h-[313px] aidriven ai-drivenimg duration-300   ' />
                            </div>
                            <div className=' p-5 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-grey_gradient font-poppins font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>Multi-chain trading</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-5 sm:mt-6 lg:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-snow_drift_light bg-dark_red rounded-3xl overflow-hidden ai-drivencard h-full'>
                            <div className=' max-w-[440px] max-h-[313px] rounded-tl-3xl rounded-tr-[24px] overflow-hidden '>
                                <img src={AIdriven3} alt="aidriven" className='xl:w-[440px] xl:h-[313px] aidriven ai-drivenimg duration-300 ' />
                            </div>
                            <div className=' p-5 sm:p-6 xl:pb-12 xl:px-12 xl:pt-[39px]'>
                                <p className=' text_driven text-transparent bg-clip-text bg-grey_gradient font-poppins font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>Lightning-fast execution</p>
