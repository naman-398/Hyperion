        ...
        <div className=' mt-[50px] sm:mt-20 xl:mt-[140px] bg-[url(./assets/images/webp/ai-drivenbg.webp)] bg-cover bg-center bg-no-repeat' >
            <div className=' max-w-[1409px] mx-auto px-3'>
                <div className=' flex min-[1200px]:items-end justify-between flex-col min-[1200px]:flex-row'>
                    <h2 className=' min-[1200px]:max-w-[864px] text-center font-poppins font-medium  text-transparent bg-clip-text bg-grey_gradient1 tracking-[-2%] text-[26px] 576:text-[30px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]'> The hyperion
                ...
                <div className=' flex flex-wrap justify-center flex-row -mx-3 mt-[30px] sm:mt-[64px]'>
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] bg-[#1616168A] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            ...
                            <div className=' p-5 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-grey_gradient1 font-poppins font-medium text-[24px] md:text-[28px] lg:text-[30px] leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>AI-Driven insights</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-5 sm:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] bg-[#1616168A] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            ...
                            <div className=' p-5 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-grey_gradient1 font-poppins font-medium text-[24px] md:text-[28px] lg:text-[30px] leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>Multi-chain trading</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-5 sm:mt-6 lg:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] bg-[#1616168A] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            ...
                            <div className=' p-5 sm:p-6 xl:pb-12 xl:px-12 xl:pt-[39px]'>
                                <p className=' text_driven text-transparent bg-clip-text bg-grey_gradient1 font-poppins font-medium text-[24px] md:text-[28px] lg:text-[30px] leading-[30px] tracking-[-2%] pb-2 sm:pb-6'>Lightning-fast execution</p>
