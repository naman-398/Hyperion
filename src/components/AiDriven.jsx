            ...
            <div className=' max-w-[1409px] mx-auto px-3'>
                ...
                <div className=' flex flex-wrap justify-center flex-row -mx-3 mt-[30px] sm:mt-[64px]'>
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            ...
                            <div className=' p-3 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-text_gradient1 font-poppins font-medium text-[30px] leading-[30px] tracking-[-2%] pb-6'>AI-Driven insights</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-3 sm:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            <div className=' p-3 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-text_gradient1 font-poppins font-medium text-[30px] leading-[30px] tracking-[-2%] pb-6'>Multi-chain trading</p>
                    ...
                    <div className=' w-full sm:w-1/2 lg:w-1/3 px-3 mt-3 sm:mt-6 lg:mt-0'>
                        <div className='border-[1px] max-w-[440px] mx-auto lg:mx-0 border-solid border-[#F9F9F714] rounded-[24px] overflow-hidden aiDrivencard h-full'>
                            ...
                            <div className=' p-3 sm:p-6 xl:p-12'>
                                <p className=' text-transparent bg-clip-text bg-text_gradient1 font-poppins font-medium text-[30px] leading-[30px] tracking-[-2%] pb-6'>Lightning-fast execution</p>
