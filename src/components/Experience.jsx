                ...
                <div className='bg-experience bg-center bg-no-repeat max-w-[1488px] mx-auto  xl:py-[120px] lg:py-[95px] md:py-[70px] sm:py-[55px] py-[48px]'>
                    <div className='flex w-100 items-center justify-center lg:justify-start'>
                        <div className=' lg:flex flex-col lg:pl-[84px] md:px-4 px-3'>
                            <h2 className='text-center lg:text-start  font-poppins text_gredient1 text-transparent bg-clip-text font-medium text-[26px] 576:text-[30px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]  max-w-[692px]'>Experience the hyperion difference</h2>
