                    ...
                    <div className="flex flex-wrap items-start justify-between flex-row -mx-3">
                        <div className=" w-full md:w-1/2 xl:w-5/12 px-3">
                            ...
                            <div className='flex sm:gap-[17px] gap-3 lg:mt-12 md:mt-10 sm:mt-8 mt-4 justify-center md:justify-start'>
                                <a href="https://www.instagram.com/" className=' duration-300 hover:-translate-y-3' target='_blank'><Insta /></a>
                                <a href="https://www.facebook.com/" className=' duration-300 hover:-translate-y-3' target='_blank'> <Facebook /></a>
                                <a href="https://www.twitter.com/" className=' duration-300 hover:-translate-y-3' target='_blank'><Twitter /></a>
                                <a href="https://www.linkedin.com/" className=' duration-300 hover:-translate-y-3' target='_blank'><Linkedin /></a>
                                <a href="https://www.telegram.com/" className=' duration-300 hover:-translate-y-3' target='_blank'><Telegram /></a>
                            </div>
                        </div>
                        <div className=" w-full md:w-1/2 xl:w-7/12 2xl:w-6/12 flex flex-row xl:flex-col mt-6 md:mt-0 md:justify-start px-3 gap-6 xl:gap-0 justify-center">
                            <ul className=' flex flex-col xl:flex-row  gap-4 sm:gap-8 md:ms-auto'>
                                <li className='text-base text-[#B1B1B0] font-poppins flex-nowrap flex font-normal leading-[20.8px]'> <a href="#home" className=' relative after:absolute after:w-0 after:h-[1px] after:rounded-[20px] after:bg-snow_drift after:left-[50%] after:bottom-[-2px] hover:after:w-full hover:after:left-0 after:duration-300'> Welcome</a></li>
                                <li className='text-base text-[#B1B1B0] font-poppins flex-nowrap flex font-normal leading-[20.8px]'> <a href="#trade" className=' relative after:absolute after:w-0 after:h-[1px] after:rounded-[20px] after:bg-snow_drift after:left-[50%] after:bottom-[-2px] hover:after:w-full hover:after:left-0 after:duration-300'> Trade with AI</a></li>
                                <li className='text-base text-[#B1B1B0] font-poppins flex-nowrap flex font-normal leading-[20.8px]'> <a href="#feature" className=' relative after:absolute after:w-0 after:h-[1px] after:rounded-[20px] after:bg-snow_drift after:left-[50%] after:bottom-[-2px] hover:after:w-full hover:after:left-0 after:duration-300'> Discover features</a></li>
                                <li className='text-base text-[#B1B1B0] font-poppins flex-nowrap flex font-normal leading-[20.8px]'> <a href="#join" className=' relative after:absolute after:w-0 after:h-[1px] after:rounded-[20px] after:bg-snow_drift after:left-[50%] after:bottom-[-2px] hover:after:w-full hover:after:left-0 after:duration-300'> Join community</a></li>
