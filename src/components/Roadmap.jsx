                    ...
                    <div className="flex flex-col gap-12 md:gap-[70px] lg:gap-[100px] xl:gap-[160px] timeline_container relative">
                        ...
                        <div className=' flex flex-wrap mx-[-12px] flex-col lg:flex-row relative items-center z-10 sm:pl-[50px] pl-8'>
                            ...
                            <div className=' md:w-10/12 w-full lg:w-6/12 px-3'>
                                ...
                                <p className=' mt-3 sm:mt-4 md:mt-6 font-poppins text-snow_drift max-w-[618px] opacity-70 text-base sm:text-[18px] leading-[23.4px] font-normal'>At Hyperion, our team of experts is dedicated to your success. Get personalized support  and guidance whenever you need it — whether it's about platform features or refining your trading strategy.</p>
                            </div>
                            <div className="md:w-10/12 w-full lg:w-6/12 px-3">
                        ...
                        <div className=' flex flex-wrap mx-[-12px] flex-col lg:flex-row relative items-center z-10 sm:pl-[50px] pl-8'>
                            ...
                            <div className=' md:w-10/12 w-full lg:w-6/12 px-3'>
                                ...
                                <p className=' mt-3 sm:mt-4 md:mt-6 font-poppins text-snow_drift max-w-[618px] opacity-70 text-base sm:text-[18px] leading-[23.4px] font-normal'>Up your trading game with Hyperion. Join thousands of traders already benefiting from our platform and start your AI-powered Perps Trading journey today.</p>
                            </div>
                            <div className="md:w-10/12 w-full lg:w-6/12 px-3">
