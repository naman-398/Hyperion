    ...
    return (
        <>
            <div className='xl:mt-[140px] lg:mt-24 md:mt-20 mt-14 sm:mt-16 px-3' id='feature'>
                <h2 className='text-center xl:mb-[84px] lg:mb-[70px] md:mb-[55px] mb-10 font-poppins grey_gradient1 text-transparent bg-clip-text font-medium text-[26px] 576:text-[30px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]'>The Hyperion Features
                </h2>
                    ...
                    <div className=" flex flex-col-reverse min-[1380px]:flex-row flex-wrap pt-12">
                        ...
                        <div className="min-[1380px]:w-[67.7%] aiDrivencard min-[1380px]:pl-12 min-[1380px]:border-l-[1px] border-l-[#1E1E1F]">
                            <div className=" flex flex-col lg:flex-row md:gap-10 gap-6 items-center justify-center lg:gap-12">
                                <div className="w-full max-w-[392px] max-h-[294px] md:max-h-[370px] lg:min-h-[520px] h-full overflow-hidden rounded-3xl border-[1px] border-solid  border-[#F9F9F714]"><img src={graphimg2} alt="img" className=" lg:min-h-[520px] w-full h-full aiDrivenimg duration-300 " /></div>
