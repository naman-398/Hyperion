    ...
    return (
        <>
            <div className='xl:mt-[140px] lg:mt-24 md:mt-20 mt-14 sm:mt-16 px-3' id='feature'>
                <h2 className='text-center xl:mb-[84px] lg:mb-[70px] md:mb-[55px] mb-10 font-poppins text-grey_gradient text-transparent bg-clip-text font-medium text-2xl 576:text-3xl sm:text-4xl md:text-xxl lg:text-5xl xl:text-vxl md:leading-[56px] leading-[36px] 576:leading-[40px] sm:leading-[46px]'>The Hyperion Features
                </h2>
                <div className='max-w-[1368px] mx-auto'>
                            ...
                            return (
                                <div className={`${index == 0 ? " max-[1200px]:flex items-center justify-center min-[1200px]:w-[32.3%] w-full md:w-[50%]  md:pr-3" : index == 1 ? "md:border-l-[1px] border-l-dark_voilet min-[1200px]:border-r-[1px] mt-12 md:mt-0 flex md:pl-3 min-[1200px]:px-3 items-center justify-center min-[1200px]:w-[35.4%] w-full md:w-[50%] border-r-dark_voilet" : index == 2 ? " min-[1200px]:w-[32.3%] w-full min-[1200px]:pl-3 flex items-center justify-center max-[1200px]:mt-12 min-[1200px]:items-end flex-col" : ""} h-full`}>
                                    <div className=" min-[1200px]:max-w-[392px] max-w-[450px] group">
                                        ...
                                        <p className='text-center md:text-start  text-grey_gradient text-transparent bg-clip-text font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] lg:mt-12 mt-5 md:mt-9 lg:pb-6 pb-3 font-poppins'>{obj.title}</p>
                    ...
                    <div className="flex flex-col-reverse min-[1380px]:flex-row flex-wrap pt-12">
                        <div className="max-[1380px]:mt-12 max-[1380px]:flex items-center justify-center min-[1380px]:w-[32.3%] h-full ">
                            <div className=" max-w-[392px] ai-drivencard">
                                <p className='text-center min-[1380px]:text-start  text-grey_gradient text-transparent bg-clip-text font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] lg:pb-6 pb-3 font-poppins'>Integrations</p>
                        ...
                        <div className="min-[1380px]:w-[67.7%] ai-drivencard min-[1380px]:pl-12 min-[1380px]:border-l-[1px] border-l-dark_voilet">
                            <div className=" flex flex-col lg:flex-row md:gap-10 gap-6 items-center justify-center lg:gap-12">
                                ...
                                <div className=" flex flex-col max-w-[600px]">
                                    <p className='text-center lg:text-start  text-grey_gradient text-transparent bg-clip-text font-medium text-2xl md:text-xlg lg:text-3xl leading-[30px] lg:pb-6 md:pb-4 pb-3 font-poppins'>AI Trading Indicators
                                    </p>
